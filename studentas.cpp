...
void Studentas::apskaiciuotiGalutini(bool naudotiMediana) {
    double nd_rez = naudotiMediana ? skaiciuotiMediana() : skaiciuotiVidurki();
    galutinis_ = 0.4*nd_rez + 0.6*egz_;
}
...
std::istream& operator>>(std::istream& is, Studentas& st) { return st.nuskaitymas(is, true); }
std::ostream& operator<<(std::ostream& os, const Studentas& st) { st.spausdinti(os); return os; }
